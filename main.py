...
st.subheader('Powered by LlamaIndex 🦙')
...
with st.expander('What this app is about?'):
    ...
    The model is instructed about the current user's identity and decides whether to share the data or not based on the policy.
    
    High level architecture:
    """
    st.image('https://i.postimg.cc/vB8zH5Jg/diagram-llama.png', use_column_width=True)
